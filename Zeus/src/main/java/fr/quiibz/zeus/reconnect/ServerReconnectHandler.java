package fr.quiibz.zeus.reconnect;
...
public class ServerReconnectHandler extends AbstractReconnectHandler {
    ...
    {
        return InstanceManager.get().getRandomServer(ServerType.LOBBY).toServerInfo();
    }
